<?php
session_start();
// İf Auth True Dont Do Any Thing
// İf No Auth Make New Token
if (!$_SESSION['TOKEN']){
    include "Auth.php";
     //header("location:http://barcode.tesetturpazari.info/reader.php");
}else{
    //echo $_SESSION['TOKEN'];
...
<link rel="shortcut icon" href="barcode.ico">
...
<div class=" modal fade in " id="AlertModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div id="AlertModalMSG" class="modal-body">
        ...
      </div>
    ...
    <img src="barcode.png" alt="" width="20%" style="margin-left: 700px;">
    <br>
          ...
          <div class="col-md-12">
            ...
            <form class="" name="readerForm" id="readerForm">
              <div class="form-group">
                ...
                <input type="hidden" name="Token" value="<?=$_SESSION['TOKEN'];?>" id="Token">
